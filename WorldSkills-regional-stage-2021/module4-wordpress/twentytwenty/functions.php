...
//========================================================
function qrpage_connect_plagin() {
$link = get_permalink();

$html = "
	<script type='text/javascript' src='" . get_template_directory_uri() . "/js/qrcode.js'></script>
...
add_shortcode('qrpage', 'qrpage_connect_plagin');
//========================================================
/**
